  ...
  return (
    <main className={`flex w-full h-full bg-stone-800`}>
      ...
      <div className={'w-full flex items-center justify-center bg-primary-100 dark:bg-dark-900'}>
        {/* <TJSScene /> */}
        <TJSBlob />
        <span className="absolute text-3xl sm:text-5xl leading-relaxed md:text-5xl text-center max-w-2xl  text-primary-700 px-4 md:px-0 md:leading-relaxed dark:text-dark-100 pointer-events-none">
